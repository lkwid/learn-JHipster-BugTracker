...
import io.github.lkwid.domain.Project;
import io.github.lkwid.repository.ProjectRepository;
...
/**
 * REST controller for managing {@link io.github.lkwid.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
